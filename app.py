...
# User input for dietary preferences
dietary_restriction = st.selectbox("Select dietary preference (optional):", ["None", "Vegetarian", "Vegan",To enhance the user interface in the `app.py` file by adding a button to clear the search input and results, I will make the following changes:

### Changes to be Made:
1. Add a button that allows users to clear the search input and results.

### SEARCH/REPLACE Format:
Here is the expected output in the required format:
